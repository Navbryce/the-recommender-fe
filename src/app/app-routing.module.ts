...
import { RcvResultsScreenComponent } from 'src/app/rcv/rcv-results-screen/rcv-results-screen.component';
...
const routes: Routes = [
  ...
  {
    path: `${ROUTES.election.path}/:id/${ROUTES.election.routes.results.path}`,
    component: RcvResultsScreenComponent,
  },
];
